...
if __name__ == "__main__":
    ...
    if use_cuda and torch.cuda.is_available():
        print('cuda ready...')
        device = 'cuda:3'
    model = DIFM(linear_feature_columns=linear_feature_columns, dnn_feature_columns=dnn_feature_columns,
                   task='binary',
    ...
    torch.save(model,'run_difm_all_epoch10_drop30_adam_l2-4.h5')
    print("")
