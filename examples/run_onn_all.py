...
if __name__ == "__main__":
    ...
    model = ONN(linear_feature_columns=linear_feature_columns, dnn_feature_columns=dnn_feature_columns,
                   task='binary',
                   l2_reg_embedding=1e-4, device=device,dnn_dropout=0.3,l2_reg_linear=1e-4,dnn_use_bn=False)
    ...
    torch.save(model,'run_onn_all_epoch10_drop30_adam_l2-4.h5')
    print("")
